...
const chapterTrendChartRef=ref<HTMLElement>(), bookTrendChartRef=ref<HTMLElement>(), successfulBooksChartRef=ref<HTMLElement>(), successRateChartRef=ref<HTMLElement>(), siteContributionChartRef=ref<HTMLElement>(), funnelChartRef=ref<HTMLElement>()
