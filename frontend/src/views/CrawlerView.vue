...
:deep(.task-action-cluster){display:inline-flex;align-items:center;gap:4px;padding:4px;border:1px solid var(--border-color-light);border-radius:13px;background:color-mix(in srgb,var(--surface-elevated) 88%,transparent);box-shadow:0 3px 10px color-mix(in srgb,var(--text-primary) 5%,transparent);white-space:nowrap}:deep(.task-action-cluster .el-button){height:28px;margin-left:0;padding:5px 11px;border-color:transparent;background:transparent;font-size:11px;font-weight:700;transition:background .18s ease,color .18s ease,box-shadow .18s ease}:deep(.task-action-cluster .task-action-details){background:var(--primary-alpha-10);color:var(--primary)}:deep(.task-action-cluster .task-action-details:hover),:deep(.task-action-cluster .task-action-details:focus-visible){background:var(--primary);color:#fff;box-shadow:0 4px 10px color-mix(in srgb,var(--primary) 22%,transparent)}:deep(.task-action-cluster .task-action-pause){color:var(--text-secondary)}:deep(.task-action-cluster .task-action-pause:hover),:deep(.task-action-cluster .task-action-pause:focus-visible){background:var(--surface-card);color:var(--text-primary)}:deep(.task-action-cluster .task-action-cancel){color:var(--danger)}:deep(.task-action-cluster .task-action-cancel:hover),:deep(.task-action-cluster .task-action-cancel:focus-visible){background:color-mix(in srgb,var(--danger) 10%,transparent);color:var(--danger)}:deep(.task-action-cluster .el-dropdown){display:inline-flex}:deep(.task-action-cluster .task-action-more){width:28px;padding:0;color:var(--text-tertiary)}:deep(.task-action-cluster .task-action-more:hover),:deep(.task-action-cluster .task-action-more:focus-visible){background:var(--surface-card);color:var(--text-primary)}
