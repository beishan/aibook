...
.crawler-book-cover-badges{position:absolute;bottom:8px;left:8px;z-index:2;display:flex;max-width:calc(100% - 16px);flex-wrap:wrap;gap:5px}.crawler-book-cover-badges :deep(.el-tag){max-width:100%;border:0;box-shadow:0 3px 10px rgba(0,0,0,.16);backdrop-filter:blur(8px)}
