<template>
  <main class="crawler-page">
    ...
    <el-dialog v-model="queuedTasksDialog" :title="`当前排队任务 · ${queuedTasks.length}`" width="min(1040px, calc(100vw - 32px))" class="queued-tasks-dialog" append-to-body>
