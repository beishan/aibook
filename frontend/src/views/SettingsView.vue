...
.theme-preview-natural::after {
  ...
  box-shadow: 0 5px 12px rgba(22, 82, 56, 0.18), inset 0 1px 0 white;
  color: #286b4e;
  font-size: 9px;
  letter-spacing: 3px;
...
.dock-settings-reveal-enter-active,
.dock-settings-reveal-leave-active {
  transition: opacity 0.28s ease, transform 0.34s cubic-bezier(0.22, 1, 0.36, 1);
}

.dock-settings-reveal-enter-from,
.dock-settings-reveal-leave-to {
  opacity: 0;
