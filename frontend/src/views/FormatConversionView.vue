        ...
        <div v-if="task" class="tab-content-shell">
          <section class="panel source-card">
            ...
            <div class="source-grid">
              <div class="cover-box" @click="coverInput?.click()"><img v-if="coverObjectUrl" :src="coverObjectUrl" alt="书籍封面" /><span v-else>{{ task.title?.charAt(0) || '书' }}</span><em>点击上传封面</em></div>
